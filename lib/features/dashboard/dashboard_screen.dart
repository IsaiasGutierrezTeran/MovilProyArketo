...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Future<DashboardSummary> _load() async => DashboardSummary.fromJson(
    await context.read<Api>().get('/projects/dashboard/'),
  );
              ...
              if (_inviteCount > 0) ...[
                ...
                Card(
                  ...
                  child: ListTile(
                    ...
                    title: Text(
                      'Tienes $_inviteCount ${_inviteCount == 1 ? 'invitación pendiente' : 'invitaciones pendientes'}',
                    ),
                    subtitle: const Text('Toca para revisarlas'),
                    trailing: const Icon(Icons.chevron_right),
                    onTap: () => context.push('/invitations').then((_) {
                      if (mounted) _loadInvites();
                    }),
                  ),
                ),
              ],
