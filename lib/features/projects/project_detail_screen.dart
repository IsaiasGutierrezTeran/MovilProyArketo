...
class _ProjectDetailScreenState extends State<ProjectDetailScreen> {
  ...
  String _detector =
      'mock'; // mock | maskrcnn (real Mask R-CNN via floorplan-api)
        ...
        child: Column(
          ...
          children: [
            ListTile(
              ...
              onTap: () {
                Navigator.pop(ctx);
                _uploadPlan(ImageSource.camera);
              },
            ),
            ListTile(
              ...
              onTap: () {
                Navigator.pop(ctx);
                _uploadPlan(ImageSource.gallery);
              },
            ),
          ],
        ),
  ...
  Future<void> _analyze() async {
    ...
    try {
      _risk = RiskAnalysis.fromJson(
        await _api.post('/risk/analyze', {'model3d': _current!.id}),
      );
    } on ApiError catch (e) {
      _snack(e.message);
    } finally {
  ...
  Widget build(BuildContext context) {
    ...
    final canDesign =
        context.read<AuthService>().user?.hasRole(['arquitecto']) ?? false;
    return Scaffold(
      appBar: AppBar(
                ...
                children: [
                      ...
                      child: _current?.glbUrl != null
                          ? Column(
                              children: [
                                ...
                                Text(
                                  '${_current!.elementCount} elementos',
                                  style: const TextStyle(color: kMuted),
                                ),
                              ],
                            )
                          : const Padding(
                              ...
                              child: Text(
                                'Sin modelo 3D. Genera uno desde un plano o importa un .glb.',
                      ...
                      if (canDesign) ...[
                        ...
                        DropdownButton<String>(
                          ...
                          items: const [
                            ...
                            DropdownMenuItem(
                              value: 'maskrcnn',
                              child: Text('Mask R-CNN'),
                            ),
                          ],
                          onChanged: (v) =>
                              setState(() => _detector = v ?? 'mock'),
                        ),
                      ],
                    ],
                  ),
                  if (canDesign) ...[
                    ...
                    SizedBox(
                      ...
                      child: OutlinedButton.icon(
                        ...
                        label: Text(
                          _uploading ? 'Subiendo…' : 'Subir / capturar plano',
                        ),
                      ),
                    ),
                  ] else
                    const Padding(
                      ...
                      child: Text(
                        'Solo un arquitecto puede subir planos y generar el 3D.',
                        style: TextStyle(color: kMuted, fontSize: 12),
                      ),
                    ),
                  const SizedBox(height: 8),
                      ...
                      child: ListTile(
                        ...
                        trailing: !canDesign
                            ...
                            : (_running == pl.id
                                  ...
                                  : FilledButton(
                                      onPressed: () => _generate(pl),
                                      child: const Text('Generar 3D'),
                                    )),
                      ),
                    ),
                  ),
                  ...
                  Row(
                    children: [
                      ...
                      TextButton.icon(
                        onPressed: () =>
                            context.push('/projects/${widget.id}/budget'),
                      ...
                      .map(
                        (b) => Card(
                          child: ListTile(
                            ...
                            subtitle: Text(
                              'Materiales ${b.materialsCost} · Mano de obra ${b.laborPeople} pers.',
                            ),
                      ...
                      child: Column(
                        ...
                        children: [
                          GradientButton(
                            ...
                            onPressed: (_current == null || _analyzing)
                                ? null
                                : _analyze,
                          ),
                          if (_risk != null) ...[
