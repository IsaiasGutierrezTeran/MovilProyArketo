...
class _AiDesignScreenState extends State<AiDesignScreen> {
  final _prompt = TextEditingController(
    text: 'Casa de 6 x 4 metros con una puerta',
  );
  ...
  Future<void> _loadProjects() async {
    final r = await context.read<Api>().page(
      '/projects/',
      query: {'page_size': 100},
    );
    setState(
  ...
  Future<void> _generate() async {
    ...
    try {
      final d = await context.read<Api>().post('/ai-design/text', {
        'prompt': _prompt.text,
        'project': _project,
        'provider': 'mock',
      });
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        ...
        const Text(
          'Genera un plano 3D desde una descripción.',
        ...
        TextField(
          ...
          decoration: const InputDecoration(
            labelText: 'Describe el plano (incluye medidas)',
          ),
        ),
        ...
        DropdownButtonFormField<int?>(
          ...
          decoration: const InputDecoration(
            labelText: 'Proyecto destino (opcional)',
          ),
        ...
        if (_result != null) ...[
          ...
          if (_result!.transcript.isNotEmpty)
            Text(
              '“${_result!.transcript}”',
          ...
          if (_result!.model?.glbUrl != null)
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      '${_result!.model!.elementCount} elementos',
                      style: const TextStyle(color: kMuted),
                    ),
                  ],
                ),
            ...
            const Card(
              child: Padding(
                ...
                child: Text(
                  'Vista previa generada. Elige un proyecto para guardar el modelo.',
                  style: TextStyle(color: kMuted),
                ),
              ),
            ),
