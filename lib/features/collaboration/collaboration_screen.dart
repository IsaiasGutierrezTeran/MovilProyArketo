...
class _CollaborationScreenState extends State<CollaborationScreen> {
  ...
  Future<void> _addComment() async {
    ...
    try {
      final d = await _api.post('/comments/', {
      ...
      body: _loading
          ...
          : ListView(
              ...
              children: [
                ...
                if (canInvite) ...[
                  const Text(
                    'Elige un usuario e invítalo; deberá aceptar para colaborar.',
                                ...
                                items: _assignable
                                    .map(
                                      (u) => DropdownMenuItem(
                                        value: u.id,
                                        child: Text(
                                          '${u.fullName.isEmpty ? u.email : u.fullName} · ${u.role}',
                  ...
                  const Padding(
                    ...
                    child: Text(
                      'La colaboración requiere el plan Pro o superior. Mejora tu plan para invitar colaboradores.',
                ...
                ..._members.map(
                  (m) => Card(
                    child: ListTile(
                      ...
                      title: Text(
                        m.userFullName.isEmpty ? m.userEmail : m.userFullName,
                      ),
